...
\begin{figure}[H]
\centering
\subfigure[瞄准模块电路原理图\label{fig:aim-schematic}]{{\includegraphics[width=0.58\textwidth]{images/chapters/fig-aim-schematic.png}}}
\hfill
\subfigure[瞄准模块电路PCB布局\label{fig:aim-pcb}]{{\includegraphics[width=0.36\textwidth]{images/chapters/fig-aim-pcb.png}}}
\caption{瞄准模块电路原理图与PCB布局}
\label{fig:aim-board}
\end{figure}
...
\begin{figure}[H]
\centering
\subfigure[电源电路原理图\label{fig:power-schematic}]{{\includegraphics[width=1\textwidth]{images/chapters/fig-power-schematic.png}}}
\hfill
\subfigure[电源电路PCB布局\label{fig:power-pcb}]{{\includegraphics[width=1\textwidth]{images/chapters/fig-power-pcb.png}}}
...
\begin{figure}[H]
\centering
\subfigure[自动循迹底盘电路原理图\label{fig:chassis-schematic}]{{\includegraphics[width=0.8\textwidth]{images/chapters/fig-chassis-schematic.png}}}
\hfill
\subfigure[自动循迹底盘电路PCB实物图\label{fig:chassis-pcb}]{{\includegraphics[width=0.8\textwidth]{images/chapters/fig-chassis-board.png}}}
