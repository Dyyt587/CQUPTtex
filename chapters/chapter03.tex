...
瞄准模块以STM32H743核心板为中心，外围扩展RS485电机总线接口、HiPNUC IMU串口接口和视觉串口接口。电路原理图如图\ref{fig:aim-schematic}所示，PCB布局如图\ref{fig:aim-pcb}所示。

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/chapters/fig-aim-schematic.png}
\caption{瞄准模块电路原理图}
\label{fig:aim-schematic}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{images/chapters/fig-aim-pcb.png}
\caption{瞄准模块电路PCB布局}
\label{fig:aim-pcb}
\end{figure}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.45\textwidth]{images/chapters/fig-ms4010-motor.png}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/chapters/fig-power-schematic.png}
\caption{电源电路原理图}
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.55\textwidth]{images/chapters/fig-power-pcb.png}
\caption{电源电路PCB布局}
\label{fig:power-pcb}
\end{figure}
...
底盘子系统以MSPM0G3507（Arm Cortex-M0+，80\,MHz）为主控，连接八路模拟量灰度传感器与MG513X减速电机编码器。相比数字量灰度传感器，模拟量传感器可输出连续电压信号，内置自动校准功能，无需每次重启重新标定阈值，更有利于差速Cloud PID控制的丝滑运行。底盘控制电路原理图与PCB布局如图\ref{fig:chassis-schematic}和图\ref{fig:chassis-pcb}所示。

\begin{figure}[htbp]
\centering
\includegraphics[width=0.85\textwidth]{images/chapters/fig-chassis-schematic.png}
\caption{自动循迹底盘电路原理图}
\label{fig:chassis-schematic}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.65\textwidth]{images/chapters/fig-chassis-pcb.png}
\caption{自动循迹底盘电路PCB布局}
\label{fig:chassis-pcb}
\end{figure}
