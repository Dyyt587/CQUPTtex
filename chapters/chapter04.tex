...
（３）\textbf{视觉节点启动}：Linux侧加载视觉模型与目标管理模块，基于嵌入式视觉系统框架\cite{Borg2019EmbeddedVision}，建立与云台主控的数据通道并开始输出目标信息；
...
视觉端采用"三线程+双队列"结构，该架构吸收了孪生网络\cite{Bertinetto2016SiamFC}和区域提议网络\cite{Li2019SiamRPN}的实时追踪思想：
