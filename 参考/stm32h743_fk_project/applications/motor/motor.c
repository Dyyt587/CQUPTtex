...
int motor_updata_cfg(int id, int level)
{
    ...
    case 0:
        ...
        APID_Init(motor->pid_torque, APID_POSITION, motor->pid_torque->parameter.kp, motor->pid_torque->parameter.ki, motor->pid_torque->parameter.kd);
        APID_Init(motor->pid_speed, APID_POSITION, motor->pid_speed->parameter.kp, motor->pid_speed->parameter.ki, motor->pid_speed->parameter.kd);
        APID_Init(motor->pid_pos, APID_POSITION, motor->pid_pos->parameter.kp, motor->pid_pos->parameter.ki, motor->pid_pos->parameter.kd);
