...
#define Perimeter	0.2042	    //轮子周长(单位:m)=0.67*3.1415926
#define Wheelspacing 0.12f		//主动轮轴距(单位:m)
#define PI 3.1415926
//电机速度控制相关参数结构体
typedef struct  
{
...
extern uint8_t round_number;	//走的总圈数
extern uint8_t turn_number;

extern float turn_p;	//转向环系数
extern float fllow_speed;//直行速度
